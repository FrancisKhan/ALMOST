...
MatrixXd BaseADSCode::calcMMatrix(Eigen::MatrixXd &diffMatrix)
{
...
MatrixXd BaseADSCode::calcFMatrix()
{
...
VectorXd BaseADSCode::calcFissionPowerDistribution()
{
...
Eigen::MatrixXd BaseADSCode::getInterfaceDiffcoefficients()
{
...
MatrixXd BaseADSCode::calcDiffOperatorMatrix()
{
...
MatrixXd BaseADSCode::applyBoundaryConditions(MatrixXd &M)
{
    MatrixXd D          = m_mesh.getDiffusionConstants();
    MatrixXd totXS      = m_mesh.getTotalXSs();
    VectorXd cellSizes  = m_mesh.getCellSizes("cm");
