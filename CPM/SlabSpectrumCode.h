#ifndef SLABSPECTRUMCODE_H
#define SLABSPECTRUMCODE_H

#include "BaseSpectrumCode.h"
#include <unsupported/Eigen/CXX11/Tensor>

class SlabSpectrumCode : public BaseSpectrumCode
{
public:
    SlabSpectrumCode(Reactor &reactor, Library &library, SolverData &solverData) :
